           ...
           author: "Alexander Adeniyin Ewetumo",
            ...
            extendWith : function(to,from){
               ...
               create : function(classname,ability,parent){
                  ...
                  if(parent){ ToolStack.Class.inherit(Class,parent); }
                  
                  if(ability){
                     if(!ability.instance && !ability.static){ 
                        ToolStack.Class.extendWith(Class.prototype, ability);
                     }
                     if(ability.instance){ 
                        ToolStack.Class.extendWith(Class.prototype, ability.instance);
                     }
                     if(ability.static){ 
                        ToolStack.Class.extendWith(Class,ability.static);
                     }
                  }
