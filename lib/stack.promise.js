      ...
      promise = function PromiseCreator(fn){
         ...
         su.extends(deferred, {
               ...
               then: function(done,fail,progress){
                  ...
                  self.then(function(){
                    if(!su.isFunction(done)) return self.done(defer.resolve);
                    var ret = done.apply(self,arguments);
                    if(ret && isPromise(ret)) ret.then(defer.resolve);
                    else defer.resolve(ret);
                    
                  },function(){
                    if(!su.isFunction(fail)) return self.fail(defer.reject);

                  },function(){
                    if(!su.isFunction(progress)) return self.fail(defer.notify);
