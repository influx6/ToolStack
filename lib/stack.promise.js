(function(name,fn){
	if(typeof define !== undefined) define(fn);
	else if(typeof module.exports !== undefined) module.exports = fn;
	else this[name] = fn;
})("Promises",function(ToolStack){
	
    if(!ToolStack.ToolChain) throw new Error("Please loadup stack.toolchain.js first!");
    if(!ToolStack.Callbacks) throw new Error("Please loadup stack.callbacks.js first!");
